...
<input type="radio" class="radionappi" name="maksettu" value="ON" ><c:out value="ON" /> </input>
<input type="radio" class="radionappi" name="maksettu" value="EI" checked> <c:out value="EI" /> </input>
<br />
<br />
<button type="submit" name="action" value="talleta vuokraus">Talleta vuokraus</button>
<button type="submit" name="action" value="peruuta">Peruuta</button>
</form>
</div>
</body>
</html>